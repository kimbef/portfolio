    ...
    <Container maxWidth="lg">
      <Box sx={{ py: { xs: 4, md: 8 } }}>
        ...
        <Grid container spacing={6} sx={{ mb: 8 }}>
          ...
          <Grid item xs={12} md={6}>
            <Stack spacing={3}>
              <Typography variant="h4" sx={{ color: 'grey.100', fontWeight: 'bold' }}>
                Hi, I'm Kliment Petrov
              </Typography>
              <Typography sx={{ color: 'grey.400', lineHeight: 1.8 }}>
        ...
        <Grid container spacing={4} sx={{ mb: 8 }}>
          <Grid item xs={12} md={4}>
            ...
            >
              ...
              <Typography variant="h6" sx={{ color: 'grey.100', mb: 3 }}>
                Frontend
              </Typography>
              <Stack spacing={2}>
                {skills.frontend.map((skill) => (
                  <Box key={skill.name}>
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', mb: 1 }}>
                      <Typography sx={{ color: 'grey.400' }}>{skill.name}</Typography>
                      <Typography sx={{ color: 'grey.400' }}>{skill.level}%</Typography>
                    </Box>
                    <LinearProgress
                      variant="determinate"
                      value={skill.level}
